...
export function useMissionProofTarget() {
  ...
  const target = useMemo(() => {
    ...
    const cachedMission = queryClient
      .getQueriesData({ queryKey: ["guildMissions"] })
    ...
    return {
      ...
      guild,
      guildId,
      cancelPath: guildId ? `/?guildId=${encodeURIComponent(guildId)}` : "/",
    };
